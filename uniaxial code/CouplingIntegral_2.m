function y = CouplingIntegral_2(w,et,ez,mut,muz,wm,vm,vn,a,b,d,Mhxm,Mhxn,Mhym,lamx)
...
B11sumterm2=(w.*ez.*eps0.*Clamx).*sum( (1-exp(-1j.*lamylpsi.*b) )./...
    ( lamylpsi.*(lamylpsi.^2 + lamxl.^2).*(lamylpsi.^2 - kym^2).*( ( (-1).^l ) + 1.*(l==0)) ),1);
